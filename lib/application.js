...
Object.defineProperty(Application.prototype, 'proxy', {
  /**
   * Get the proxy trust function.
   * See: https://github.com/expressjs/proxy-addr
   *
  ...
  set: function (val) {
    this._proxy = typeof val === 'function'
      ? val
...
Application.prototype.proxy = function () {
  return false;
};
